...
public class Timer : MonoBehaviour
{
    ...
    public void UpdateHighScore()
    {
        if (SceneManager.GetActiveScene().name == "StageOne")
        {
            if (timer < StageOneHighScore) StageOneHighScore = timer;
        }
        else if (SceneManager.GetActiveScene().name == "StageTwo")
        {
            if (timer < StageTwoHighScore) StageTwoHighScore = timer;
        }
        else if (SceneManager.GetActiveScene().name == "StageThree")
        {
            if (timer < StageThreeHighScore) StageThreeHighScore = timer;
        }
    }
}
